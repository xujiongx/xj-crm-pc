...
import { OperateResizeHandlers } from '@/pages/MotionVideo/interface';
import { ImageClipedEmitData } from '@/pages/MotionVideo/types/edit';
import { ImageClipDataRange } from '@/pages/MotionVideo/types/slides';
...
const ImageClipHandler = (props: any) => {
  ...
  const { useKeyboardStore, useMainStore } = store;
