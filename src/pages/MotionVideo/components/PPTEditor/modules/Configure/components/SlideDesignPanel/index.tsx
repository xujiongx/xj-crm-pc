...
const SlideDesignPanel: React.FC = () => {
  ...
  const { applyThemeToAllSlides } = useSlideTheme();
      ...
      {background.type === 'gradient' && (
        <div className="background-gradient-wrapper">
          <div className="row">
            ...
            <ColorPicker
              value={
                background.gradientColor ? background.gradientColor[0] : '#fff'
              }
              onChange={(color) =>
                updateBackground({
                  gradientColor: [
          ...
          <div className="row">
            ...
            <ColorPicker
              value={
                background.gradientColor ? background.gradientColor[1] : '#fff'
              }
              onChange={(color) =>
                updateBackground({
                  gradientColor: [
