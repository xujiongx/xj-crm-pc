...
const ColorPicker: React.FC<ColorPickerProps> = ({
  ...
  const updateRecentColorsCache = useCallback(
    debounce(() => {
  ...
  const changeColor = (
    ...
    if (onChange)
      onChange(`rgba(${value.r}, ${value.g}, ${value.b}, ${value.a})`);
  };
    ...
    <div className="color-picker">
      ...
      <div className="picker-field">
        ...
        <div
          ...
          onClick={() => selectPresetColor('#00000000')}
        >
          <Checkboard />
        </div>
      </div>
      ...
      {recentColors.length > 0 && (
        <div className="recent-colors-title">最近使用：</div>
      )}
      <div className="picker-presets">
        {recentColors.map((c) => (
          <div
          ...
          >
            <div
              className="picker-presets-color-content"
              style={{ background: c }}
            ></div>
          </div>
        ))}
